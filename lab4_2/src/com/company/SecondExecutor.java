...
//this executor makes all the characters lowercase

public class SecondExecutor implements ru.spbstu.pipeline.Executor {
    ...
    public SecondExecutor(Logger logger, String config)
    {
        this.log = logger;
        this.st = Status.OK;
    ...
    public SecondExecutor(String config, Logger logger)
    {
        this.log = logger;
        this.st = Status.OK;
        consumer_intype = String.class.getCanonicalName();
